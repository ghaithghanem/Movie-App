...
abstract class MovieRepository {
  ...
  /// Deletes the movie detail from the database.
    Future<Either<DatabaseException, void>> deleteMovieDetail({required String? movieId});

  /// Checks if the movie detail is saved in the database.
  Future<Either<DatabaseException, bool>> isSavedMovieDetail({required String? movieId});
  }